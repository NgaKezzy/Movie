...
abstract class AppLocalizations {
  ...
  /// No description provided for @movieName.
  ///
  /// In en, this message translates to:
  /// **'Movie Name'**
  String get movieName;

  /// No description provided for @movieContent.
  ///
  /// In en, this message translates to:
  /// **'Movie Content'**
  String get movieContent;
  ...
  /// No description provided for @movieGenre.
  ///
  /// In en, this message translates to:
  /// **'Movie Genre'**
  String get movieGenre;

  /// No description provided for @movieDirector.
  ///
  /// In en, this message translates to:
  /// **'Movie Director'**
  String get movieDirector;

  /// No description provided for @movieActor.
  ///
  /// In en, this message translates to:
  /// **'Movie Actor'**
  String get movieActor;

  /// No description provided for @watchAMovie.
  ///
  /// In en, this message translates to:
  /// **'Watch a movie'**
  String get watchAMovie;
